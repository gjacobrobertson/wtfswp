...
class GamePicker
  ...
  validates :username, :presence => {:message => :user_error}
  validates :players, :numericality => { :only_integer => true, :greater_than => 0 , :message => :players_error}
  validates :players, :numericality => { :only_integer => true, :greater_than => 1, :message => :one_player }
